...
import com.mattgould.day17.Day17;
...
//		System.out.println("Day16b took: " + timer.stop());
		timer.reset();
		timer.start();
		Day17.go("target area: x=156..202, y=-110..-69");
		System.out.println("Day17 took: " + timer.stop());
	}
